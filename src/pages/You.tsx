      ...
      >
        ...
        <div className="flex-1 mt-2">
          ...
          <div className="flex items-center justify-center sm:justify-start gap-1.5 mt-3">
            ...
            {isGoogleLinked ? (
              <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-green-500/10 border border-green-500/20 text-green-400 text-[10px] uppercase font-bold tracking-wider ml-2">
              ...
              <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-nw-danger/10 border border-nw-danger/20 text-nw-danger text-[10px] uppercase font-bold tracking-wider ml-2">
                Not Connected
              </div>
            )}
          </div>
      ...
      >
        ...
        <div className="p-4 rounded-3xl bg-nw-surface/40 border border-nw-border-subtle space-y-3">
          <div className="flex justify-between items-center py-2 border-b border-white/5">
            ...
            <span className="text-nw-text font-medium text-sm">Beta 1.3.15 (Security Update)</span>
          </div>
          ...
          <div className="flex items-center justify-between py-2">
            ...
            <span className="text-nw-text tabular-nums text-sm">2026.06.30</span>
          </div>
        </div>
